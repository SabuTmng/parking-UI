...
export default function RegisterMember(props){
    ...
    return(
        ...
        <Box spacing={3} m={10}>
            ...
            <Grid>
                <InputMask style = {{width: 350 ,  margin:10}} mask="99999-9999999-9" maskChar=" " value={citizenship_no} onChange={(event)=>{setcitizenship_no(event.target.value.replaceAll("-",""))}} >
                    {()=><TextField required label="citizenship_no" variant="outlined" style = {{width: 350 ,  margin:10}}  />}
                </InputMask>
            </Grid>
